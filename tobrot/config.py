...
class Config(Config):
    ...
    OWNER_ID = 1640567687
    AUTH_CHANNEL = [-1001463255443,1204927413,1640567687]
    UPLOAD_AS_DOC = "False"
    LEECH_COMMAND = "leech@CerminStreamRobot"
    GLEECH_COMMAND = "gleech@CerminStreamRobot" 
    YTDL_COMMAND = "ytdl@CerminStreamRobot"
    PYTDL_COMMAND = "pytdl@CerminStreamRobot"
    INDEX_LINK = "https://nando.xyz/0:"
    TELEGRAM_LEECH_COMMAND_G = "tleech@CerminStreamRobot"
    GET_SIZE_G = "getsize@CerminStreamRobot"
    LOG_COMMAND = "log@CerminStreamRobot"
    RENEWME_COMMAND = "renewme@CerminStreamRobot"
    CLONE_COMMAND_G = "gclone@CerminStreamRobot"
    STATUS_COMMAND = "server@CerminStreamRobot"
